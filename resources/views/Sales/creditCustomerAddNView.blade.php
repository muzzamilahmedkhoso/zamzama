						...
						<div class="well">
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<span class="subHeadingLabelClass">Add Credit Customer</span>
										</div>
									</div>
									...
									<div class="panel">
										<div class="panel-body">
											<div class="row">
												<?php
													echo Form::open(array('url' => 'sad/addCreditCustomerDetail','id'=>'addCreditCustomerForm'));
												?>
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<span class="subHeadingLabelClass">View Credit Customer</span>
										</div>
									</div>
									<div class="lineHeight">&nbsp;</div>
									<div class="panel">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(function(){
			$('#addCreditCustomerForm').on('submit',function(e){
    			$.ajaxSetup({
        		...
        		$.ajax({
					type:"POST",
        			url:'<?php echo url('/')?>/sad/addCreditCustomerDetail',
        			data:$(this).serialize(),
        			dataType: 'json',
        			success: function(data){
            			console.log(data);
